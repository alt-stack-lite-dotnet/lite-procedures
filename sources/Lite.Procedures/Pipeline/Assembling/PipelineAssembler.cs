...
namespace Lite.Procedures.Assembling
{
    ...
    /// over <see cref="IServiceProvider"/> as they prefer. Sync procedures have their own
    /// assembler (<see cref="Pipeline.ProcedurePipeline{TArguments,TResult}"/> constructor);
